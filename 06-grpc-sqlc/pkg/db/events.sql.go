...
SELECT event_id, event_privacy, name, type, department, regions, tags, start_at FROM events WHERE event_id = $1
`
...
SELECT event_id, event_privacy, name, type, department, regions, tags, start_at FROM events
...
RETURNING event_id, event_privacy, name, type, department, regions, tags, start_at
`
